...
async def refresh_token(
    ...
    print("Incoming refresh_token:", refresh_token)
    print("Endpoint sees cookie:", refresh_token)
    if not refresh_token:
        raise HTTPException(status_code=401, detail="Refresh token missing")

    refresh_token = refresh_token.strip('"')
    print("Incoming cookie:", refresh_token)
    ...
    # Отмечаем старый токен как revoked
